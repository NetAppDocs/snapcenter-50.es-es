...
Consulte link:task_view_custom_plug_in_resource_backups_and_clones_in_the_topology_page.html["Consulte los clones y backups relacionados con los recursos de plugins personalizados en la página Topology"].
