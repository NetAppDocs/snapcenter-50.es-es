...
Para obtener información sobre los cmdlets de PowerShell, use la ayuda de cmdlets de SnapCenter o consulte https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.htmlll["Guía de referencia de cmdlets de SnapCenter Software"^].
