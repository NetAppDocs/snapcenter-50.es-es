...
. Haga clic en image:../media/more_icon.gif[""] el icono y haga clic en *Iniciar servicio* o *Reiniciar servicio*.
+
...
. Haga clic en el image:../media/more_icon.gif[""] icono y, a continuación, haga clic en *Suspender programación* para colocar el host de este plugin en modo de mantenimiento.
+
