...
Panel de actividades
 a| 
.. Después de iniciar la operación de backup, haga clic en image:../media/activity_pane_icon.gif["icono del panel actividad"] en el panel Activity para ver las cinco operaciones más recientes.
