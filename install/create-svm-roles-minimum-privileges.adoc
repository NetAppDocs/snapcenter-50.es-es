...
NOTE: Desde SnapCenter 5,0, los usuarios administradores de Vserver solo son compatibles con las API REST. Si desea crear roles con un administrador que no sea de Vserver, debe usar ZAPI.
