...
. Seleccione los clones y, a continuación, haga clic image:../media/delete_icon.gif[""] en para eliminar clones o en image:../media/split_cone.gif[""] para dividir los clones.
