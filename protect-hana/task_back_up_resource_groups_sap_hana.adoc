...
+
Se puede buscar el grupo de recursos escribiendo su nombre en el cuadro de búsqueda o seleccionando image:../media/filter_icon.png[""]y, luego, seleccionar la etiqueta. A continuación, puede seleccionar image:../media/filter_icon.png[""] cerrar el panel de filtros.
