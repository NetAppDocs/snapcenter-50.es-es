...
+
Puede buscar el grupo de recursos escribiendo el nombre en el cuadro de búsqueda o haciendo clic en image:../media/filter_icon.png[""] y seleccionado la etiqueta. A continuación, puede hacer clic en image:../media/filter_icon.png[""] para cerrar el panel de filtros.
